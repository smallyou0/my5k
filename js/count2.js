$(document).ready(function() {
    ...
    $('#plusParticipant').click(function() {
        ...
        newParticipant.find('input[class="join_size"]').val('S');
        newParticipant.find('input[class="join_cnt"]').val('0');
	...
	//	사이즈
	$(document).on("click", ".size-radio li span.size_btn", function() {
		$(this).parents(".size-radio").find("li span.size_btn").removeClass("on");
		$(this).addClass("on");
		var data = $(this).data("join_size");
		$(this).parents(".size-radio").find("input[name='join_size[]']").val(data);
	});
